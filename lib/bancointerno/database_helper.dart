...
// DatabaseHelper é uma classe utilitaria criada para centralizar e gerenciar
//todas as operações de conexão, criação, migração e manipulação do banco de dados SQLite.
...
class DatabaseHelper {
  ...
  Future<Database> _initDatabase() async {
    ...
    return await openDatabase(
      ...
      //Executado somente na primeira criação do banco
